...
export const FunctionModal = ({ isOpen, onClose, functionType }: FunctionModalProps) => {
  ...
  const [sqlServers, setSqlServers] = useState<Array<{ id: string; name: string; databases: string[] }>>([]);
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => {
              setFormData((prev) => ({ ...prev, serverName: value }));
              const selected = sqlServers.find((s) => s.id === value);
              setAvailableDatabases(selected?.databases || []);
            }}
          >
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData((prev) => ({ ...prev, databaseName: value }))
            }
          >
            <SelectTrigger className="mt-1">
